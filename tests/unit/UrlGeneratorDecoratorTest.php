...
class UrlGeneratorDecoratorTest extends \Test\TestCase {
	...
	public function testLinkToDocRoot($app, $file, $args, $expectedResult) {
		\OC::$WEBROOT = '';
		$result = $this->urlGeneratorInjected->linkTo($app, $file, $args);
	...
	public function testGetWebroot() {
		\OC::$WEBROOT = '/nextcloud';
		$actual = $this->urlGeneratorInjected->getWebroot();
	...
	public function imagePathProvider(): array {
		return [
			['core', 'favicon.svg', \OC::$WEBROOT . '/core/img/favicon.svg'],
	...
	public function imageDecorationProvider(): array {
		return [
			...
			['doesntmatter', 'favicon-touch.png', '/img/favicon-touch.png'],
		];
	}

	/**
	 * @dataProvider imageDecorationProvider
	 */
	public function testImageDecoration(string $appName, string $file, string $result): void {
		$this->assertSame($this->appPath . $result, $this->urlGeneratorInjected->imagePath($appName, $file));
	}
